...
type CategoryGroup = "income" | "fixed" | "variable" | "saving" | "investment";
type CategoryWithPlanningGroup = Category & { planningGroup?: CategoryGroup };
...
function inferCategoryGroup(
  category: Pick<Category, "name" | "type"> & { planningGroup?: CategoryGroup },
): CategoryGroup {
...
export default function CategoriesPage() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    const category: CategoryWithPlanningGroup = {
