...
--   * finance rows are household-scoped through a stable owner user_id anchor;
...
-- BEGIN HOUSEHOLD-IDENTITY-1 CANONICAL OVERLAY
...
-- BEGIN AUDIT-TRAIL-1 CANONICAL OVERLAY
-- Fresh-install parity for the production AUDIT-TRAIL-1 forward migration.
...
-- END AUDIT-TRAIL-1 CANONICAL OVERLAY

-- BEGIN AUDIT-MUTATION-1 CANONICAL OVERLAY
-- Fresh-install parity for the AUDIT-MUTATION-1 forward migration.
...
-- END AUDIT-MUTATION-1 CANONICAL OVERLAY
...
GRANT EXECUTE ON FUNCTION public.decline_household_invite(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.leave_household(uuid) TO authenticated;
-- END HOUSEHOLD-WORKSPACE-1 CANONICAL OVERLAY
...
-- BEGIN FOREX-BALANCE-ASOF-1 CANONICAL OVERLAY
...
COMMIT;
-- END FOREX-BALANCE-ASOF-1 CANONICAL OVERLAY
